...
export class initDatabase1680173159276 implements MigrationInterface {
  name = 'initDatabase1680173159276';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "user" ("id" character(26) NOT NULL, "address" character varying NOT NULL, CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "event" ("id" character(26) NOT NULL, "name" character varying NOT NULL, "schema" jsonb NOT NULL, "description" character varying, "index" integer NOT NULL, "chainUuid" character NOT NULL, CONSTRAINT "PK_30c2f3bbaf6d34a55f8ae6e4614" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "workflow" ("id" character(26) NOT NULL, "status" text NOT NULL, "name" text NOT NULL, "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" character NOT NULL, "eventId" character NOT NULL, CONSTRAINT "PK_eb5e4cc1a9ef2e94805b676751b" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "workflow_log" ("id" character(26) NOT NULL, "startedAt" TIMESTAMP NOT NULL DEFAULT now(), "finishedAt" TIMESTAMP WITH TIME ZONE, "status" text NOT NULL, "input" jsonb NOT NULL, "workflowId" character NOT NULL, CONSTRAINT "PK_1c557745d8d55b468018fbe4373" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "task" ("id" character(26) NOT NULL, "type" text NOT NULL, "name" character varying NOT NULL, "dependOn" integer, "config" jsonb NOT NULL, "workflowId" character NOT NULL, CONSTRAINT "PK_fb213f79ee45060ba925ecd576e" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "task_log" ("id" character(26) NOT NULL, "startedAt" TIMESTAMP WITH TIME ZONE, "finishedAt" TIMESTAMP WITH TIME ZONE, "status" character varying NOT NULL, "workflowLogId" character NOT NULL, "taskId" character NOT NULL, "output" jsonb, "input" jsonb, "error" jsonb, CONSTRAINT "PK_0f80f57bb78387f37ef146434b8" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
