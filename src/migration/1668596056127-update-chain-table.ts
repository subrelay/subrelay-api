...
export class updateChainTable1668596056127 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "chain" ADD "createdAt" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "chain" ADD "imageUrl" character varying NOT NULL`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "chain" ADD "image_url" character varying NOT NULL`);
        await queryRunner.query(`ALTER TABLE "chain" ADD "created_at" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "chain" ADD "chain_id" character varying NOT NULL`);
    }
